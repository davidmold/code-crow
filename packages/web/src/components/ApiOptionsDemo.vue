    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        >
          ...
          <option value="plan">
            📋 Plan Mode - Claude creates a plan first, then asks for approval
          </option>
          <option value="allow">
            ✅ Allow All - Execute all actions automatically
          </option>
          <option value="deny">
            ❌ Deny All - Block all actions (analysis only)
          </option>
        </select>
      </div>
