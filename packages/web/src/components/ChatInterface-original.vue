      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              v-if="showStatus && currentStatusMessage"
              class="flex items-center space-x-3"
            >
              <div class="w-4 h-4 bg-blue-500 rounded-full animate-pulse" />
...
useWebSocket()
// executeCommand from useCommandExecution is available but not used in this component
...
onMounted(() => {
  ...
  // useWebSocket() already called above for setup
